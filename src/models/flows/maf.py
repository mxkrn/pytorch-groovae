...
class ContextMAFlow(MAFlow):
    ...
    def __init__(
        ...
        super(ContextMAFlow, self).__init__(
            dim,
            n_hidden=32,
            context=0,
            n_layers=2,
        ...
        self.context = MaskedLinear(
            dim, n_hidden, self.create_mask(dim, n_hidden, dim, "input")
        )
        self.transform = (
            activation(),
            ...
            activation(),
            MaskedLinear(
                dim, n_hidden, self.create_mask(n_hidden, dim * 2, dim, "output")
            ),
        )
